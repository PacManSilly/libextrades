            ...
            <div :class="mobileMenu ? 'scale-100 opacity-100':'scale-0 opacity-0'" class="fixed top-0 right-0 z-50 w-full h-full flex flex-col gap-y-10 py-5 bg-slate-900/80 backdrop-blur-xl items-center transition-all duration-150 lg:hidden">
                ...
                <div class="w-10/12 flex flex-col gap-y-10 mx-auto">
                    ...
                    <div class="grid grid-cols-2 gap-3 text-left">
                        ...
                        <RouterLink @click.prevent="mobileMenu = false" :to="{name: 'tradecrypto'}" class="p-2 rounded-md text-base text-slate-400 font-normal transition-all duration-150 hover:bg-slate-800 hover:text-white">Cryptos</RouterLink>
